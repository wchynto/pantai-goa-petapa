...
class TiketController extends Controller
{
    ...
    public function index()
    {
        try {
            return view('admin.tiket.index', [
                'title' => 'Jenis Tiket - Admin Pantai Goa Petapa',
    ...
    public function update(UpdateTiketRequest $request, string $id)
    {
        try {
            ...
            $this->tiketService->updateTiket($data, $id, $updateThumbnail);
            $this->kendaraanService->updateKendaraan($data, $kendaraan_uuid);
