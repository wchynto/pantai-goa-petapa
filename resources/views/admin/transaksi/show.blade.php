<x-admin.layout>
    ...
    <div class="px-4 pt-6">
        <div class="grid gap-4">
            <div
                class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-800 sm:p-6 dark:bg-gray-800">
                            ...
                            @foreach ($transaksi->transaksiTiket as $item)
                                <div
                                    ...
                                    <div class="col-span-2 sm:col-span-3">
                                        <h5
                                            class="text-lg lg:text-xl font-bold tracking-tight text-gray-900 dark:text-white">
