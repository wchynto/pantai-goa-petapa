<x-admin.layout>
  ...
  <div class="px-4 pt-6">
    <div class="grid gap-4">
      <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-800 sm:p-6 dark:bg-gray-800">
        <x-admin.card-header-add title="Detail" breadcrumbUrl="{{ route('transaksi.index') }}"
          ...
          <div class="grid gap-4 md:gap-6 md:grid-cols-4">
            <div class="col-span-4 flex justify-between md:col-span-2">
              <div>
                ...
                <h3 class="text-xl xl:text-2xl font-semibold text-gray-800 dark:text-gray-200">Super Admin</h3>
              </div>
              <div>
              ...
              @foreach ($transaksi->transaksiTiket as $item)
                <div
                  ...
                  <div class="col-span-2 sm:col-span-3">
                    ...
                    <p class="text-gray-800 dark:text-gray-400">Rp{{ number_format($item->tiket->harga, 0, ',', '.') }}
                    </p>
                  </div>
                  <div class="col-span-4 sm:col-span-3 flex justify-between">
                    <p class="font-semibold text-gray-800 dark:text-gray-400">Jumlah: {{ $item->jumlah_penumpang }}</p>
                    <p class="font-semibold text-gray-800 dark:text-gray-400">
                      Rp{{ number_format($item->tiket->harga * $item->jumlah_penumpang, 0, ',', '.') }}</p>
                  </div>
                </div>
              @endforeach
            </div>
            <div class="col-span-4 grid grid-cols-6 justify-between">
              <div class="col-span-3 md:col-span-4">
                <h4 class="lg:text-lg font-semibold text-gray-800 dark:text-gray-200">Metode Pembayaran</h4>
              ...
              <div class="col-span-3 md:col-span-2">
                ...
                <div class="flex justify-between items-center">
                  <h4 class="lg:text-lg font-semibold text-gray-800 dark:text-gray-200">Total Bayar</h4>
                  <h4 class="lg:text-lg font-semibold text-gray-800 dark:text-gray-200">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <h4 class="lg:text-lg font-semibold text-gray-800 dark:text-gray-200">
                    Rp{{ number_format($transaksi->total_bayar - $transaksi->total_harga, 0, ',', '.') }}</h4>
                </div>
              </div>
            </div>
          </div>
        ...
        <a href="{{ route('transaksi.index') }}" class="flex gap-2 items-center lg:text-lg font-semibold text-gray-800 dark:text-gray-200">
