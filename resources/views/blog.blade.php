<x-layout>
  ...
  <section class="flex flex-col justify-center mt-4">
    <div class="mt-14 inset-x-0">
      <svg xmlns="http://www.w3.org/2000/svg"class="fill-blue-100 dark:fill-gray-900" viewBox="0 70 1440 200"><path fill-opacity="1" d="M0,160L48,170.7C96,181,192,203,288,202.7C384,203,480,181,576,154.7C672,128,768,96,864,85.3C960,75,1056,85,1152,101.3C1248,117,1344,139,1392,149.3L1440,160L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"></path></svg>
    </div>
