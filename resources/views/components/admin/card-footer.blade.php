<div class="sticky bottom-0 right-0 items-center w-full bg-white sm:flex sm:justify-between dark:bg-gray-800 mt-6">
  <div class="flex items-center mb-4 sm:mb-0">
    ...
    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
      Showing <span class="font-semibold text-gray-900 dark:text-white">{{ $start }}</span>-<span
