    ...
    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5">
                <form action="{{ route('transaksi-tiket.verifikasi') }}" method="POST">
                    @csrf
                    @method('POST')
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        <div class="col-span-2">
                            ...
                            <input type="text" name="no_tiket" id="no_tiket"
                                ...
                                placeholder="Masukkan no_tiket" required="" name="no_tiket">
                            @error('no_tiket')
                    ...
                    <button type="submit"
                        ...
                        <svg class="mea-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                            xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd"
                ...
                <hr class="my-4">
                <div>
                    <h1 class="mb-2">Scan Kode QR</h1>
                    <div id="reader" height="600px"></div>
                </div>
            </div>
        </div>
    </div>
