                            ...
                            <tr class="{{ $loop->even ? 'bg-gray-50 dark:bg-gray-700' : '' }}">
                                ...
                                <td class="p-4 whitespace-nowrap inline-flex justify-center w-full">
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-target="editCategoryModal-{{ $item->uuid }}"
                                        data-modal-toggle="editCategoryModal-{{ $item->uuid }}">
                                    ...
                                    {{-- Edit Kategori Modal --}}
                                    <div id="editCategoryModal-{{ $item->uuid }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                ...
                                                <form class="p-4 md:p-5" method="POST"
                                                    action="{{ route('kategori.update', $item->uuid) }}">
                                                    @csrf
                                                    @method('PUT')
                                    ...
                                    <div class="fixed left-0 right-0 z-50 items-center justify-center hidden overflow-x-hidden overflow-y-auto top-4 md:inset-0 h-modal sm:h-full"
                                        ...
                                        <div class="relative w-full h-full max-w-md px-4 md:h-auto">
                                            ...
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                                                ...
                                                <!-- Modal body -->
                                                <form class="p-4 md:p-5" method="POST"
                                                    action="{{ route('kategori.destroy', $item->uuid) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" name="kategori_id"
                                                        value="{{ $item->uuid }}">
