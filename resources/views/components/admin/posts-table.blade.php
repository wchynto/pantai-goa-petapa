<div class="flex flex-col mt-4">
  <div class="min-w-full align-middle">
    <div class="overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600 display" id="posts-table">
            ...
            <tr>
              ...
              <td class="p-4 whitespace-nowrap">
                ...
                <button
                  ...
                  data-modal-target="deletePengunjungModal-{{ $p->uuid }}"
                  data-modal-toggle="deletePengunjungModal-{{ $p->uuid }}">
                  <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                    height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                  ...
                  id="deletePengunjungModal-{{ $p->uuid }}">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                      ...
                      <div class="flex justify-end p-2">
                        <button type="button"
                          ...
                          data-modal-hide="deletePengunjungModal-{{ $p->uuid }}">
                      ...
                      <!-- Modal body -->
                      <form class="p-4 md:p-5" method="POST" action="{{ route('postingan.destroy', $p->uuid) }}">
                        @csrf
                        @method('Delete')
                        <input type="hidden" name="postingan_id" value="{{ $p->uuid }}">
