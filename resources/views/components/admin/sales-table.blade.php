                        ...
                        @foreach ($data as $item)
                            <tr class="{{ $loop->even ? 'bg-gray-50 dark:bg-gray-700' : '' }}">
                                ...
                                <td class="p-4 whitespace-nowrap">
                                    ...
                                    <div id="editTransaksiModal-{{ $item['transaksi_id'] }}" tabindex="-1"
                                        aria-hidden="true"
                                                        ...
                                                        <div class="col-span-2">
                                                            ...
                                                            <div class="w-full flex gap-4">
                                                                <input type="text"
                                                                    ...
                                                                    id="nama_pengunjung" name="nama_pengunjung"
                                                                    value="{{ $item['nama_pengunjung'] }}" readonly>
                                                            </div>
                                                        </div>
                                                        <div class="col-span-2">
                                                            <div class="w-full flex flex-col gap-4">
                                                                @foreach ($item['tiket'] as $tiket)
                                                                    <div class="flex gap-4 ticket-row">
                                                                        <div class="flex-1">
                                                                            ...
                                                                            <select id="tiket-1" name="tiket[]"
                                                                                ...
                                                                                <option value="" selected="">
                                                                                    Pilih tiket</option>
                                                                                <option value="tiket-1"
                                                                                    {{ $tiket[0] == 'Pejalan Kaki' ? 'selected' : '' }}>
                                                                                    Pejalan Kaki</option>
                                                                                <option value="tiket-2"
                                                                                    {{ $tiket[0] == 'Sepeda' ? 'selected' : '' }}>
                                                                                    Sepeda
                                                                                </option>
                                                                                <option value="tiket-3"
                                                                                    {{ $tiket[0] == 'Sepeda Motor' ? 'selected' : '' }}>
                                                                                    Sepeda Motor</option>
                                                                                <option value="tiket-4"
                                                                                    {{ $tiket[0] == 'Mobil' ? 'selected' : '' }}>
                                                                                    Mobil
                                                                                </option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="w-fit">
                                                                            <label
                                                                                for="jumlah-{{ $item['transaksi_id'] }}-{{ $loop->index + 1 }}"
