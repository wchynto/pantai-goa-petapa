                ...
                <ul class="py-2 space-y-2">
                    <li>
                        <a href="{{ route('admin.dashboard') }}"
                            ...
                            <svg class="w-6 h-6 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white {{ request()->routeIs('admin.dashboard') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                ...
                <ul class="py-2 space-y-2">
                    <li>
                        <a href="{{ route('transaksi.index') }}"
                            ...
                            <svg class="w-6 h-6 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white {{ request()->routeIs('transaksi.*') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="{{ route('transaksi-tiket.index') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('transaksi-tiket.*') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg class="w-6 h-6 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white {{ request()->routeIs('transaksi-tiket.*') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="{{ route('tiket.index') }}"
                            ...
                            <svg class="w-6 h-6 transition duration-75 group-hover:text-gray-900 dark:group-hover:text-white {{ request()->routeIs('tiket.*') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5 2a2 2 0 00-2 2v14l3.5-2 3.5 2 3.5-2 3.5 2V4a2 2 0 00-2-2H5zm2.5 3a1.5 1.5 0 100 3 1.5 1.5 0 000-3zm6.207.293a1 1 0 00-1.414 0l-6 6a1 1 0 101.414 1.414l6-6a1 1 0 000-1.414zM12.5 10a1.5 1.5 0 100 3 1.5 1.5 0 000-3z"
                                    clip-rule="evenodd"></path>
                            </svg>
                            <span class="ml-3" sidebar-toggle-item>Jenis Tiket</span>
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pengunjung.index') }}"
                            ...
                            <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white {{ request()->routeIs('pengunjung.*') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                ...
                <ul class="py-2 space-y-2">
                    <li>
                        <a href="{{ route('postingan.index') }}"
                            ...
                            <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white {{ request()->routeIs('postingan.*') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                    ...
                    <li>
                        <a href="{{ route('kategori.index') }}"
                            ...
                            <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white {{ request()->routeIs('kategori.*') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                fill="currentColor" viewBox="0 0 24 24">
                                <path
                ...
                <ul class="py-2 space-y-2">
                    <li>
                        <a href="{{ route('admin.laporan') }}"
                            class="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group dark:text-gray-200 dark:hover:bg-gray-700 {{ request()->routeIs('admin.laporan') ? 'bg-gray-100 dark:bg-gray-700' : '' }}">
                            <svg class="w-6 h-6 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white {{ request()->routeIs('admin.laporan') ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400' }}"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
