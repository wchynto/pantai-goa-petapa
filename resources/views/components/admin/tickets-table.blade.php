              ...
              <tr class="{{ $loop->even ? 'bg-gray-50 dark:bg-gray-700' : '' }}">
                ...
                <td class="p-4 whitespace-nowrap">
                  ...
                  <button type="button"
                    ...
                    data-modal-target="editTicketModal-{{ $item->uuid }}"
                    data-modal-toggle="editTicketModal-{{ $item->uuid }}">
                  ...
                  {{-- Edit Tiket Modal --}}
                  <div id="editTicketModal-{{ $item->uuid }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative w-full h-full max-w-2xl px-4 md:h-auto">
                      ...
                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <!-- Modal body -->
                        <form class="p-4 md:p-5" method="POST" action="{{ route('tiket.update', $item->uuid) }}">
                          @csrf
                          @method('PUT')
