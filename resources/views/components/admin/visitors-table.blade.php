<div class="flex flex-col mt-4">
  <div class="min-w-full align-middle">
    <div class="overflow-x-auto">
      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600 display" id="visitors-table">
        ...
        <tbody class="bg-white dark:bg-gray-800">
          @foreach ($items as $item)
            <tr>
              ...
              <td class="p-4 whitespace-nowrap">
                {{-- Edit Button --}}
                <a href="{{ route('pengunjung.edit', $item->uuid) }}"
                ...
                <button
                  ...
                  data-modal-target="deletePengunjungModal-{{ $item->uuid }}"
                  data-modal-toggle="deletePengunjungModal-{{ $item->uuid }}">
                  <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
                    height="24" fill="none" viewBox="0 0 24 24">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div
                  ...
                  id="deletePengunjungModal-{{ $item->uuid }}">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                      ...
                      <div class="flex justify-end p-2">
                        <button type="button"
                          ...
                          data-modal-hide="deletePengunjungModal-{{ $item->uuid }}">
                      ...
                      <!-- Modal body -->
                      <form class="p-4 md:p-5" method="POST" action="{{ route('pengunjung.destroy', $item->uuid) }}">
                        @csrf
                        @method('DELETE')
                        <input type="hidden" name="pengunjung_id" value="{{ $item->uuid }}">
