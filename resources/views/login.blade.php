          ...
          <div class="flex flex-col sm:flex-row">
            <div class="flex flex-col items-center gap-4 text-center">
              ...
              <p class="text-gray-400">
                Nikmati keindahan alam dan<br>suara ombak yang <br>menenangkan jiwa Anda
              </p>
              ...
              <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ route('user.login') }}" method="POST">
                  ...
                  <p class="text-sm text-center font-light text-gray-500 dark:text-gray-400">
                    Belum punya akun?
                    <a href="register"
                      class="font-medium text-gray-600 hover:underline dark:text-primary-500">Register</a>
                  </p>
                </form><br><br>
              </div>
            </div>
