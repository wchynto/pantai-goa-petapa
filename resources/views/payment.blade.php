          ...
          <div class="w-full bg-blue-200 border border-gray-200 shadow-xl sm:p-6 md:p-8 dark:bg-gray-900 dark:border-gray-600 my-4 rounded-lg py-4">
            ...
            <div class="mt-10 flex flex-row mx-4 lg:mx-0">
              <div class="w-1/2 flex items-center">
                <a href="confirmation-order" class="flex items-center">
