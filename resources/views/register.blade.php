            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <div class="w-1/2">
                    <div class="mt-20 flex flex-col sm:flex-row">
                        <div class="w-1/6">
                            <img src="{{ asset('images/logo_pantai-goa-petapa_147x147.png') }}"
                                alt="Hero Pantai Goa Petapa">
                        </div>
                        <div class="py-1 px-5 text-right">
                            <h1
                                class="text-lg font-bold leading-tight tracking-tight text-blue-900 md:text-lg dark:text-blue-900">
                    ...
                    <div class="flex flex-col items-center justify-center md:h-screen lg:py-0 mt-0">
                        <div
                            ...
                            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                                ...
                                <form class="space-y-4 md:space-y-6" action="{{ route('pengunjung.store') }}"
                                    method="POST">
                                    @csrf
                                    @method('POST')
                                    ...
                                    <div>
                                        <label for="password2"
                                            ...
                                            Password</label>
                                        <input type="password" name="confirmation_password" id="password"
                                            placeholder="••••••••"
                                            class="bg-white shadow border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            required="">
                                    </div>
                                    ...
                                    <button type="submit"
                                        ...
                                        Account</button>
                                    <button type="submit"
                                        class="w-full flex items-center justify-center text-gray-900 bg-white shadow border-blue-900 hover:bg-blue-600 hover:text-white focus:border-blue-900 focus:outline-none focus:ring-blue-900 font-medium rounded-lg sm:text-sm px-5 py-2.5 text-center dark:bg-white dark:hover:bg-blue-600 dark:hover:text-white dark:focus:ring-primary-800"><img
                                            src="{{ asset('images/google.png') }}" width="20"
                                            alt="">&ensp;&emsp;Sign up with Google</button>
