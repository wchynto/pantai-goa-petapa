        ...
        <div class="w-full md:w-1/4">
          <div
            ...
            <div class="flex flex-col items-center justify-center gap-2 text-center">
              ...
              <h1 class="text-xl font-bold text-gray-800 dark:text-gray-200">{{ auth()->user()->pengunjung->nama }}</h1>
                  ...
                  @foreach ($transaksi->transaksiTiket as $item)
                    <div
                      ...
                      <div class="col-span-4 sm:col-span-3 flex justify-between">
                        <p class="font-semibold text-gray-800 dark:text-gray-400">Jumlah: {{ $item->jumlah_penumpang }}
                        </p>
