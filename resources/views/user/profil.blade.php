            ...
            <div class="flex flex-col md:flex-row gap-4">
                ...
                <div class="w-full md:w-3/4">
                    <div
                        ...
                        @endif
                        <form action="{{ route('user.profil.update', auth()->user()->pengunjung->uuid) }}"
                            ...
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6">
                                    <label for="nama"
                                        class="b
    /**lock mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama</label>
                                ...
                                <div class="col-span-6">
                                    <label for="foto"
                                        ...
                                        Profil</label>
                                    <img class="w-20 h-20 rounded-full shadow-lg mb-2"
                                        src="{{ auth()->user()->foto ? Storage::url(auth()->user()->foto) : asset('images/default-profile.png') }}"
                                        alt="User Photo">
